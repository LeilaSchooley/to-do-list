...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clickImportantStuff": () => (/* binding */ clickImportantStuff),
/* harmony export */   "showByWeek": () => (/* binding */ showByWeek)
/* harmony export */ });
/* harmony import */ var _queryElements__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./queryElements */ "./src/queryElements.js");
...
/* harmony import */ var date_fns_endOfDay__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns/endOfDay */ "./node_modules/date-fns/esm/endOfDay/index.js");
/* harmony import */ var date_fns_differenceInCalendarDays__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns/differenceInCalendarDays */ "./node_modules/date-fns/esm/differenceInCalendarDays/index.js");
...
function showImportantStuff() {
    (0,_queryElements__WEBPACK_IMPORTED_MODULE_0__.removeTodoContainer)()

    Object.keys(localStorage).forEach(key => {
            let newObjArray = JSON.parse(localStorage.getItem(key));
            newObjArray.forEach(element => {
                if (element.priority == "High") (0,_render__WEBPACK_IMPORTED_MODULE_1__.renderTodo)(element)
            })
        }
...
function arrangeByWeek() {
    ...
    ;(0,_queryElements__WEBPACK_IMPORTED_MODULE_0__.removeTodoContainer)()
    let todaysDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns_endOfDay__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date()), 'yyyy, MM, dd')
    ...
    Object.keys(localStorage).forEach(key => {
            ...
            newObjArray.forEach(element => {
                if (element.dueDate != "No due date") {
                    ...
                    let elementDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(element.dueDate), 'yyyy, MM, dd')

                    let result = (0,date_fns_differenceInCalendarDays__WEBPACK_IMPORTED_MODULE_5__["default"])(
...
/* harmony export */   "setdisplayBlock": () => (/* binding */ setdisplayBlock)
/* harmony export */ });
/* harmony import */ var _queryElements__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./queryElements */ "./src/queryElements.js");
...
function removeAllModals() {
    ...
    if (!(0,_queryElements__WEBPACK_IMPORTED_MODULE_0__.checkForElementID)("editForm")) {
...
/* harmony export */   "addAllProjects": () => (/* binding */ addAllProjects)
/* harmony export */ });
...
/* harmony import */ var _queryElements_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./queryElements.js */ "./src/queryElements.js");
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./localStorage */ "./src/localStorage.js");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index */ "./src/index.js");
/* harmony import */ var _changeModalState__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./changeModalState */ "./src/changeModalState.js");
...
function createProjectForm() {
    document.body.appendChild((0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__["default"])(`
...
function createNewProject() {
    ...
    newProjectsButton.addEventListener("click", () => {
        ...
        if ((0,_queryElements_js__WEBPACK_IMPORTED_MODULE_1__.checkForElementID)("project-name")) {

            createProjectForm()

            ;(0,_changeModalState__WEBPACK_IMPORTED_MODULE_4__.setdisplayBlock)("projectModal")
            ;(0,_changeModalState__WEBPACK_IMPORTED_MODULE_4__.changeModalState)("projectModal")
    ...
    function submitNewProject() {
        ...
        submitProject.addEventListener("click", (e) => {
            ...
            if (projectName != "") {
                ...
                (0,_localStorage__WEBPACK_IMPORTED_MODULE_2__.saveProjectToLocalStorage)(projectName);
...
function addAllProjects() {
    ...
    let activeProject = (0,_queryElements_js__WEBPACK_IMPORTED_MODULE_1__.getProjectName)()

    ;(0,_queryElements_js__WEBPACK_IMPORTED_MODULE_1__.removeAllProjectButtons)()


    Object.keys(localStorage).forEach(key => {

        if (key === activeProject) {
            sidePanel.appendChild((0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__["default"])(`<button id='${key}' class='project-buttons panel-button current-project'>${key}</button>`))

        } else sidePanel.appendChild((0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__["default"])(`<button id='${key}' class='project-buttons panel-button'>${key}</button>`))
...
function showAllProjects() {
    ...
    allProjectsButton.addEventListener("click", () => (0,_localStorage__WEBPACK_IMPORTED_MODULE_2__.renderAllTodosLocalStorage)())
...
/* harmony import */ var _queryElements_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./queryElements.js */ "./src/queryElements.js");
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./localStorage */ "./src/localStorage.js");
/* harmony import */ var _changeModalState__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./changeModalState */ "./src/changeModalState.js");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index */ "./src/index.js");

const randomID = __webpack_require__(/*! @justinaz90/random-id-generator */ "./node_modules/@justinaz90/random-id-generator/index.js");
...
function createNewTodo() {
    if ((0,_queryElements_js__WEBPACK_IMPORTED_MODULE_1__.checkForElementID)("title")) {

        createTodoForm();

        (0,_changeModalState__WEBPACK_IMPORTED_MODULE_3__.setdisplayBlock)("todoModal");
        (0,_changeModalState__WEBPACK_IMPORTED_MODULE_3__.changeModalState)("todoModal");
        ...
        todoSubmit.addEventListener("click", (e) => {
            ...
            if (title != "") {
                ...
                let currentProject = (0,_queryElements_js__WEBPACK_IMPORTED_MODULE_1__.getProjectName)();

                (0,_localStorage__WEBPACK_IMPORTED_MODULE_2__.saveTodoToLocalStorage)(currentProject, newTodoList)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "editSubmitTodo": () => (/* binding */ editSubmitTodo),
...
function createEditForm(toDoList) {
    ...
    return (0,_createElement_js__WEBPACK_IMPORTED_MODULE_1__["default"])(`
...
/* harmony export */   "viewToDoDetails": () => (/* binding */ viewToDoDetails),
/* harmony export */   "deleteTodo": () => (/* binding */ deleteTodo)
/* harmony export */ });
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./localStorage */ "./src/localStorage.js");
/* harmony import */ var _arrangeTodos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./arrangeTodos */ "./src/arrangeTodos.js");
/* harmony import */ var _queryElements_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./queryElements.js */ "./src/queryElements.js");
/* harmony import */ var _createNewTodo_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createNewTodo.js */ "./src/createNewTodo.js");
/* harmony import */ var _createNewProject_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createNewProject.js */ "./src/createNewProject.js");
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.css */ "./src/style.css");
/* harmony import */ var _changeModalState__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./changeModalState */ "./src/changeModalState.js");
/* harmony import */ var _editSubmitTodo__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editSubmitTodo */ "./src/editSubmitTodo.js");
...
(0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.saveProjectToLocalStorage)("Default Project")
;(0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.renderProjectLocalStorage)("Default Project")
viewToDoDetails()
;(0,_createNewProject_js__WEBPACK_IMPORTED_MODULE_4__.addAllProjects)()

let newTodoButton = document.getElementById("new-todo")
newTodoButton.addEventListener("click", () => (0,_createNewTodo_js__WEBPACK_IMPORTED_MODULE_3__.createNewTodo)())
...
function selectProject() {
    ...
    projectButtons.forEach(element => element.addEventListener("click", () => {
        ...
        ;(0,_queryElements_js__WEBPACK_IMPORTED_MODULE_2__.removeClassList)()
...
function getProjectTodos() {
    ...
    (0,_queryElements_js__WEBPACK_IMPORTED_MODULE_2__.removeTodoContainer)()

    let activeProject = (0,_queryElements_js__WEBPACK_IMPORTED_MODULE_2__.getProjectName)()

    if (activeProject === "All Projects") (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.renderAllTodosLocalStorage)()

    else (0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.renderProjectLocalStorage)(activeProject)
    ...
    deleteButton.addEventListener("click", (e) => {
        ...
        localStorageProject.forEach((obj, index) => {
            ...
            if (obj.id === e.target.id) {
                ...
                ;(0,_localStorage__WEBPACK_IMPORTED_MODULE_0__.updateProjectArray)(activeProject, localStorageProject)
                getProjectTodos()
            }
...
function showEditForm(editTodoButton, toDoList) {
    editTodoButton.addEventListener("click", () => {
            ...
            document.body.appendChild((0,_editSubmitTodo__WEBPACK_IMPORTED_MODULE_7__.createEditForm)(toDoList))
            ;(0,_changeModalState__WEBPACK_IMPORTED_MODULE_6__.setdisplayBlock)("editForm")
            ;(0,_changeModalState__WEBPACK_IMPORTED_MODULE_6__.changeModalState)("editForm")
            ;(0,_editSubmitTodo__WEBPACK_IMPORTED_MODULE_7__.editSubmitTodo)(toDoList)
    ...
    alldetailButtons.forEach(element => element.addEventListener("click", () => {
        ...
        Object.keys(localStorage).forEach(key => {
                ...
                newObjArray.forEach(obj => {
                    ...
                    if (obj.id === element.id && (0,_queryElements_js__WEBPACK_IMPORTED_MODULE_2__.checkForElementID)(`edit-todo-${obj.id}`)) {
                        showTodoOptions(obj)
...
(0,_createNewProject_js__WEBPACK_IMPORTED_MODULE_4__.createNewProject)()
selectProject()
;(0,_createNewProject_js__WEBPACK_IMPORTED_MODULE_4__.showAllProjects)()
...
/* harmony export */   "saveTodoToLocalStorage": () => (/* binding */ saveTodoToLocalStorage),
/* harmony export */   "renderProjectLocalStorage": () => (/* binding */ renderProjectLocalStorage),
/* harmony export */   "renderAllTodosLocalStorage": () => (/* binding */ renderAllTodosLocalStorage),
...
/* harmony import */ var _queryElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./queryElements */ "./src/queryElements.js");
...
function renderProjectLocalStorage(projectName) {
    ...
    if (newObjArray != null) newObjArray.forEach(element => (0,_render__WEBPACK_IMPORTED_MODULE_0__.renderTodo)(element))

}


function renderAllTodosLocalStorage() {
    (0,_queryElements__WEBPACK_IMPORTED_MODULE_1__.removeTodoContainer)();

    Object.keys(localStorage).forEach(function (key) {
            let newObjArray = JSON.parse(localStorage.getItem(key));
            newObjArray.forEach(element => (0,_render__WEBPACK_IMPORTED_MODULE_0__.renderTodo)(element))
        }
...
/* harmony export */   "removeTodoContainer": () => (/* binding */ removeTodoContainer),
/* harmony export */   "checkForElementID": () => (/* binding */ checkForElementID),
/* harmony export */   "removeAllProjectButtons": () => (/* binding */ removeAllProjectButtons)
/* harmony export */ });
...
function removeTodoContainer() {
    ...
    if (document.querySelector(".todo-container") != null) {
        ...
        allTodoContainers.forEach(element => element.parentNode.removeChild(element))
    }
}
...
/* harmony export */ });
/* harmony import */ var _createElement_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createElement.js */ "./src/createElement.js");
/* harmony import */ var _editSubmitTodo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editSubmitTodo */ "./src/editSubmitTodo.js");
...
let renderTodo = (toDoList) => {
    ...
    toDoContainer.appendChild((0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__["default"])(`
    ...
    toDoContainer.appendChild((0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__["default"])(`<button id='${toDoList.id}' class='edit details-button-${toDoList.id}-edit hide-form'>Edit</button> 
    
    <button id='${toDoList.id}' class='details-button-${toDoList.id} delete-button-${toDoList.id} delete hide-form'>Delete</button>`))


    toDoContainer.appendChild((0,_editSubmitTodo__WEBPACK_IMPORTED_MODULE_1__.createEditForm)(toDoList))
